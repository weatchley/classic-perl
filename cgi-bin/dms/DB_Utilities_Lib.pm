...
#
# $Source: /data/dev/rcs/dms/perl/RCS/DB_Utilities_Lib.pm,v $
#
# $Revision: 1.2 $
#
...
# Revision 1.2  2006/06/27 16:16:06  atchleyb
# CREQ 004 - Updated to force https (ssl) connection
#
# Revision 1.1  2002/03/08 21:05:16  atchleyb
# Initial revision
#
#
#
...
use vars qw($DBUser $DMSConnectPath $DMSServer);
...
$DBUser = $ENV{'DBUser'};
$DMSConnectPath = $ENV{'DMSConnectPath'};
$DMSServer = $ENV{'DMSServer'};
#$schema = $ENV{'SCHEMA'};
