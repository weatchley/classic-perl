...
# Text Menus file
#
# $Source: /home/atchleyb/rcs/mms/perl/RCS/Text_Menus.pm,v $
#
# $Revision: 1.1 $
#
# $Date: 2003/11/12 20:31:25 $
#
# $Author: atchleyb $
#
# $Locker:  $
#
# $Log: Text_Menus.pm,v $
# Revision 1.1  2003/11/12 20:31:25  atchleyb
# Initial revision
#
#
#
...
#print STDERR "Text_Menus - menuName: $menuName, name: $name, label: $label, linkStyle: $args{linkStyle}\n";
            my $prompt = "Click here for $label";
            $outputstring .= "<tr><td colspan=2 align=left>\n";
            if (substr($self->{menuList}[$i]{contents},0,11) ne 'javascript:') {
                $outputstring .= "<a href=\"javascript:showHide" . $menuName . "Menu(" . $name . "MenuOutline);\" style=\"text-decoration:$args{linkStyle}\" title='$prompt'><b>" . $label . "</b></a>\n";
            } else {
                $outputstring .= "<a href=\"javascript:showHide" . $menuName . "Menu(" . $name . "MenuOutline);" . substr($self->{menuList}[$i]{contents},11) . "\" style=\"text-decoration:$args{linkStyle}\" title='$prompt'><b>" . $label . "</b></a>\n";
            ...
            $outputstring .= "</td></tr>\n";
            #---
            $outputstring .= "<tr><td align=left width=20></td><td align=left>\n";
...
# List Menu
        ...
        for (my $i = 0; $i <= $#{ $self->{menuList} }; $i++) {
            ...
            my $prompt = "Click here for $label";
            if (substr($self->{menuList}[$i]{contents},0,11) ne 'javascript:') {
                $outputstring .= "<a href=\"javascript:showHide" . $menuName . "Menu(" . $name . "MenuOutline);\" style=\"text-decoration:$args{linkStyle}\" title='$prompt'><b>" . $label . "</b></a>" . nbspaces(5) . "\n";
            } else {
                $outputstring .= "<a href=\"javascript:showHide" . $menuName . "Menu(" . $name . "MenuOutline);" . substr($self->{menuList}[$i]{contents},11) . "\" style=\"text-decoration:$args{linkStyle}\" title='$prompt'><b>" . $label . "</b></a>" . nbspaces(5) . "\n";
            }
        }
        $outputstring .= "</td></tr></table>\n";
