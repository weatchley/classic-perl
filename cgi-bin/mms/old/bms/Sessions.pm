...
@EXPORT = qw (&sessionCreate &sessionValidate &sessionClose);
@EXPORT_OK = qw(&sessionCreate &sessionValidate &sessionClose);
%EXPORT_TAGS =(
    Functions => [qw(&sessionCreate &sessionValidate &sessionClose) ],
    Constants => [qw() ]
);
