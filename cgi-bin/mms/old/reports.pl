...
# Accounting section
        ...
        $accountingMenu->addMenu(name => "areport1", label => "Report 1", contents => "javascript:alert('Submit Report');");
        $accountingMenu->addMenu(name => "areport2", label => "Report 2", contents => "Test 2");
        $accountingMenu->addMenu(name => "areport3", label => "Report 3", contents => "Test 3");
        $accountingMenu->addMenu(name => "areport4", label => "Report 4", contents => "Test 4");
        $accountingMenu->addMenu(name => "areport5", label => "Report 5", contents => "Test 5");
        #$SomeReportMenu->addMenu(name => "areport6", label => $SomeReportMenu->label(), contents => $SomeReportMenu->contents(), title => $SomeReportMenu->label());
...
# Top menu
        ...
        my $menutype = ((defined($mmscgi->param('menutype'))) ? $mmscgi->param('menutype') : "table");
        #$menutype="tabs";
        $menu1->imageSource("$MMSImagePath/");
