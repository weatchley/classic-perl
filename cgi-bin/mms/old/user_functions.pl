...
my $Server = $mmscgi->param("server");
if (!(defined($Server))) {$Server=$MMSServer;}
...
print "<html>\n";
print "<head>\n";
print "<title>MMS User Functions</title>\n";
...
print " \n";
print "</head>\n";
print "<body background=$MMSImagePath/background.gif text=#000099 link=#0000ff vlink=#0000ff alink=#0000ff topmargin=0 leftmargin=0><center>\n";
...
if ((index($command,"form") == -1) && ($command ne "browse")) {
    ...
    if ($command eq "adduser") {
        ...
        $a_location = ((defined($mmscgi->param("location"))) ? $mmscgi->param("location") : "");
        $a_location =~ s/'/''/g;
        $a_firstname = ((defined($mmscgi->param("firstname"))) ? $mmscgi->param("firstname") : "");
        $a_firstname =~ s/'/''/g;
        $a_lastname = ((defined($mmscgi->param("lastname"))) ? $mmscgi->param("lastname") : "");
        $a_lastname =~ s/'/''/g;
        $a_organization = ((defined($mmscgi->param("organization"))) ? $mmscgi->param("organization") : "");
        $a_organization =~ s/'/''/g;
        $a_areacode = ((defined($mmscgi->param("areacode"))) ? $mmscgi->param("areacode") : "");
        $a_phonenumber = ((defined($mmscgi->param("phonenumber"))) ? $mmscgi->param("phonenumber") : "");
        $a_extension = ((defined($mmscgi->param("phoneextension"))) ? $mmscgi->param("phoneextension") : "");
        $a_email = ((defined($mmscgi->param("email"))) ? $mmscgi->param("email") : "");
        $a_email =~ s/'/''/g;
        $a_accesstype = $mmscgi->param("accesstype");
        @a_privlist = $mmscgi->param("privlist");
        ...
        $u_username = uc($mmscgi->param("u_username"));
        ...
        $u_id = $mmscgi->param("u_id");
        $u_location = $mmscgi->param("location");
        $u_location =~ s/'/''/g;
        $u_username = $mmscgi->param("u_username");
        $u_username =~ s/'/''/g;
        eval {
        ...
        $u_firstname = ((defined($mmscgi->param("firstname"))) ? $mmscgi->param("firstname") : "");
        $u_firstname =~ s/'/''/g;
        $u_lastname = ((defined($mmscgi->param("lastname"))) ? $mmscgi->param("lastname") : "");
        $u_lastname =~ s/'/''/g;
        $u_organization = ((defined($mmscgi->param("organization"))) ? $mmscgi->param("organization") : "");
        $u_organization =~ s/'/''/g;
        $u_areacode = ((defined($mmscgi->param("areacode"))) ? $mmscgi->param("areacode") : "");
        $u_phonenumber = ((defined($mmscgi->param("phonenumber"))) ? $mmscgi->param("phonenumber") : "");
        $u_extension = ((defined($mmscgi->param("phoneextension"))) ? $mmscgi->param("phoneextension") : "");
        $u_email = ((defined($mmscgi->param("email"))) ? $mmscgi->param("email") : "");
        $u_email =~ s/'/''/g;
        $u_accesstype = $mmscgi->param("accesstype");
        @u_privlist = $mmscgi->param("privlist");
        ...
        my $newuserid = uc($mmscgi->param("newuserid"));
        my $newusername;
        eval {
        ...
        my $oldpassword = $mmscgi->param("oldpassword");
        $oldpassword =~ s/'/''/g;
        my $newpassword = $mmscgi->param("newpassword");
        $newpassword =~ s/'/''/g;
...
ENDOFBLOCK
        ...
        eval {
        #    %availusers = &get_lookup_values ($dbh, $schema, 'users', 'username', "firstname || ' ' || lastname", 'id = id AND id > 0 ORDER BY username');
            print "<tr><td><b>Select User: </b>&nbsp;</td><td><select name=u_username size=1>\n";
            my $csr = $dbh->prepare("SELECT username, firstname || ' ' || lastname FROM $schema.users WHERE id > 0 ORDER BY username");
