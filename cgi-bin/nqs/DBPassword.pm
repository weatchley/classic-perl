# DB User functions
#
# $Source: /data/dev/rcs/qa/perl/RCS/DBPassword.pm,v $
#
# $Revision: 1.1 $
#
# $Date: 2004/05/30 22:56:20 $
#
# $Author: starkeyj $
#
# $Locker:  $
#
# $Log: DBPassword.pm,v $
# Revision 1.1  2004/05/30 22:56:20  starkeyj
# Initial revision
#
#
#
...
###################################################################################################################################
    ...
    eval {
        my $oldPasswordTest = &NQS_encrypt_password($args{oldpassword});
        ...
        if ($oldPasswordTest ne $oldPassword) {
            ...
            $status = $args{dbh}->do("UPDATE $args{schema}.users SET password='" . (&NQS_encrypt_password($args{newpassword})) . "', " .
...
###################################################################################################################################
    ...
    eval {
        my $testPassword = &NQS_encrypt_password($args{password});
