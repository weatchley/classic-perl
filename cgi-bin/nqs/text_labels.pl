...
#
# $Source: /data/dev/rcs/nqs/perl/RCS/text_labels.pl,v $
#
# $Revision: 1.1 $
#
# $Date: 2001/10/19 23:32:19 $
#
# $Author: starkeyj $
#
# $Locker:  $
...
&build_text (image => $image, width => $imgwidth, height => $imgheight, font => 'TimesNewRoman-Bold', size => 16, color => $textcolor,
             text => $text);
