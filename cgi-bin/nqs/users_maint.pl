...
#    $checkedifactive = ($isactive eq 'T') ? "checked" : " ";
    ...
    my %miscprivilegehash = get_lookup_values($dbh, 'privilege', 'privilege', 'id',"application = 'A'");
...
modifyform
    ...
    foreach my $key (sort keys %externalprivilegehash) {
	   ...
	   }elsif(substr($key,0, 3) eq "SNL"){
	   	$keydisplayname = $key;
	    $suboffsetANDlength = substr($keydisplayname,0, 3," Lead Lab");	
	   }else{
	   $keydisplayname = $key;
	   }	
	 	
	 	#print "<tr><td nowrap>$key</td><td valign=top><input name=e_priv $disabled type=checkbox value=\"$externalprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
	 	...
	 	if($keydisplayname ne "Supplier Schedule Approver"){
	 	print "<tr><td nowrap>$keydisplayname</td><td valign=top><input name=e_priv $disabled type=checkbox value=\"$externalprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
	 	}else{
	 	print "<tr style='display:none;'><td nowrap>$keydisplayname</td><td valign=top><input name=e_priv $disabled type=checkbox value=\"$externalprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";	
	 	}
    }
    	#print "<td width=5></td>\n";
    #print "</table></td>\n";
    print "<tr><td colspan=2 valign=top><font color=black><b>Misc. Privileges</b></font></td></tr>\n";
   # print "<tr><td nowrap>$keydisplayname</td><td valign=top><input name=e_priv $disabled type=checkbox value=\"$externalprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
   
   foreach my $key (sort keys %miscprivilegehash) {
	   my $checkedoption = defined($userprivilegehash{$miscprivilegehash{$key}}) ? "checked" : "";
	   my $keydisplayname;
	   my $suboffsetANDlength;
	   $keydisplayname = $key;
	   if($keydisplayname ne "SCCB User"){
	   print "<tr><td nowrap>$keydisplayname</td><td valign=top><input name=e_priv $disabled type=checkbox value=\"$miscprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
	   }
	}
   ...
   print "</table>\n";
    ...
    foreach my $key (sort keys %internalprivilegehash) {
	   ...
	   $keydisplayname = $key;
	 	...
	 	#print "<tr><td nowrap>$key</td><td valign=top><input name=i_priv $disabled type=checkbox value=\"$internalprivilegehash{$key}\" $checkedoption $historyDisabled></td></tr>\n";
    	...
    	if(($keydisplayname eq "M&O Internal Schedule Approver")||($keydisplayname eq "OQA Internal Schedule Approver")||($keydisplayname eq " Lead Lab Internal Schedule Approver")){
    		print "<tr style='display:none;'><td nowrap>$keydisplayname</td><td valign=top><input name=i_priv $disabled type=checkbox value=\"$internalprivilegehash{$key}\" $checkedoption $historyDisabled></td></tr>\n";
    	}else{
    		print "<tr><td nowrap>$keydisplayname</td><td valign=top><input name=i_priv $disabled type=checkbox value=\"$internalprivilegehash{$key}\" $checkedoption $historyDisabled></td></tr>\n";
    	}	
    }
    ...
    foreach my $key (sort keys %surveillanceprivilegehash) {
	   ...
	   $keydisplayname = $key;
	 	...
	 	#print "<tr><td nowrap>$key</td><td valign=top><input name=s_priv type=checkbox $disabled value=\"$surveillanceprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
    	...
    	if(($keydisplayname eq "M&O Surveillance Schedule Approver")||($keydisplayname eq "OQA Surveillance Schedule Approver")||($keydisplayname eq " Lead Lab Surveillance Schedule Approver")){
    	print "<tr style='display:none;'><td nowrap>$keydisplayname</td><td valign=top><input name=s_priv type=checkbox $disabled value=\"$surveillanceprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
    	}else{
    	print "<tr><td nowrap>$keydisplayname</td><td valign=top><input name=s_priv type=checkbox $disabled value=\"$surveillanceprivilegehash{$key}\"  $checkedoption $historyDisabled></td></tr>\n";
    	}
    }
...
addform
    ...
    foreach my $key (sort keys %externalprivilegehash) {
		if (($userprivhash{'OQA Supplier Administration'} == 1 && (substr($key,0, 3) eq "OQA" || substr($key, 0, 8) eq "Supplier")) || $userprivhash{'Developer'} == 1) {
	 	...
	 	print "<tr><td nowrap>$key</td><td valign=top><input name=e_priv type=checkbox value=\"$externalprivilegehash{$key}\" $disabled></td></tr>\n";
  	 }
  	 print "</table></td>\n";
  	 #print "<td width=5></td>\n";
  	 ...
  	 foreach my $key (sort keys %internalprivilegehash) {
    	if (($userprivhash{'BSC Internal Administration'} == 1 && substr($key,0, 3) eq "BSC") || $userprivhash{'Developer'} == 1) {
	 	...
	 	print "<tr><td nowrap>$key</td><td valign=top><input name=i_priv type=checkbox value=\"$internalprivilegehash{$key}\" $disabled></td></tr>\n";
  	 }
  	 print "</table></td>\n";
  	 #print "<td width=5></td>\n";
	 print "<td><table border=0 cellpadding=1 cellspacing=1 align=left rules=none>\n";
	 ...
	 foreach my $key (sort keys %surveillanceprivilegehash) {
    	if (($userprivhash{'BSC Surveillance Administration'} == 1 && substr($key,0, 3) eq "BSC") || $userprivhash{'Developer'} == 1) {
	 	...
	 	print "<tr><td nowrap>$key</td><td valign=top><input name=s_priv type=checkbox value=\"$surveillanceprivilegehash{$key}\" $disabled></td></tr>\n";
	 }
  	 print "</table></td></tr>\n";
    print "</table>\n";
...
#queryformtop
  ...
  my $styDis  = 'none';
  $styDis = 'block'  if ($userprivhash{'Developer'} == 1);
...
<td align=center><b  style='display:$styDis;'>Inactive users</b></td>
<tr>
...
table
  ...
  # print "</select></td>\n<td><select name=userselect size=10 ondblclick=\"ViewSelected('$action');\" onClick=\"document.usermaint.availuserselect.selectedIndex = -1;\">\n";
   print "</select></td>\n<td><select style='display:".$styDis.";' name=userselect size=10 ondblclick=\"ViewSelected('$action');\" onClick=\"document.usermaint.availuserselect.selectedIndex = -1;\">\n";
