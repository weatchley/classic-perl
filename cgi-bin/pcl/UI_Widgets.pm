# Library of UI widget routines for cgi scripts (used first for SCM)

#
# $Source: /usr/local/www/gov.ymp.intradev/rcs/pcl/perl/RCS/UI_Widgets.pm,v $
#
# $Revision: 1.6 $
#
...
#
# $Log: UI_Widgets.pm,v $
# Revision 1.6  2008/10/16 20:42:39  atchleyb
# WR103, ACR0810_001 - Alter title bar frame to use text instead of images for the title
#
# Revision 1.5  2006/01/09 23:38:43  naydenoa
# Data change - added more years to the build_date_select year dropdown.
#
# Revision 1.4  2003/02/03 20:41:45  atchleyb
# removed refs to SCM
#
# Revision 1.3  2002/10/31 17:13:49  starkeyj
# modified writeTitleBar function to reverse </tr></td> to </td></tr>
#
# Revision 1.2  2002/09/20 22:43:21  atchleyb
# removed functions replaced by new Tables.pm
#
# Revision 1.1  2002/09/17 20:17:11  atchleyb
# Initial revision
#
#
#
...
####################################################################################################################################
    ...
    $outstring .= "<select name=$elementname\_year size=1><option value=\"\"><option value=1999>1999<option value=2000>2000<option value=2001>2001<option value=2002>2002<option value=2003>2003<option value=2004>2004<option value=2005>2005<option value=2006>2006<option value=2007>2007<option value=2008>2008<option value=2009>2009<option value=2010>2010</select>\n";
...
###################################################################################################################################
   ...
   $min = &formatID('', 2, $min);
   $sec = &formatID('', 2, $sec);
   print STDERR "\n $ENV{'SYSType'} SYS error: $mon/$mday/$year $hour:$min:$sec - $username/$userid/$schema - $appError failed:\n$oracleError\n";
