...
#
# $Log: browse.pl,v $
# Revision 1.8  2003/11/28 21:25:08  starkeyj
# added radio button for Work Requests (SCR14)
#
   ...
   <script language=javascript><!--
      function doBrowse() {
         ...
         if ($form.browseoption[0].checked) {
            ...
            script = "meetings";
            //script = "blank";
            $form.project.value = $form.select8.value;
...
###################################################################################################################################
   ...
   $out .= "<tr>" . &buildNextRadioButton() . "<td><b>Work Requests</b>&nbsp;&nbsp;";
   $out .= "</table>\n</form>\n";
