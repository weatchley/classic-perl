# UI User functions
#
# $Source: /data/dev/rcs/plaqads/perl/RCS/UIUsers.pm,v $
#
# $Revision: 1.1 $
#
...
###################################################################################################################################
    ...
    $uservalues[9][0] ='<b>Roles:</b>';
    $userInfo{roles} =~ s/\t/<br>/g;
    $uservalues[9][1] ="<b>" . $userInfo{roles};
    $uservalues[10][0] = '<b>Status:</b>';
    $uservalues[10][1] = '<b>' . (($userInfo{isactive} eq 'T') ? 'Active' : 'Inactive') . '</b>';
    $uservalues[11][0] = '<b>Failed Logins:</b>';
    $uservalues[11][1] = "<b>" . $userInfo{failedattempts} . "</b>";
    $uservalues[12][0] = '<b>Lockout Time:</b>';
    $uservalues[12][1] = '<b>' . ((defined($userInfo{lockout})) ? $userInfo{lockout} : "&nbsp;") . '</b>';
