...
#
# $Source: /data/dev/rcs/prp/perl/RCS/DBLogin.pm,v $
# $Revision: 1.3 $
# $Date: 2004/06/15 23:02:07 $
# $Author: naydenoa $
# $Locker:  $
#
# $Log: DBLogin.pm,v $
# Revision 1.3  2004/06/15 23:02:07  naydenoa
# Update validateUser - cyber security password requirements
#
# Revision 1.2  2004/05/07 21:59:50  naydenoa
# Added password security updates
# Affected function: validateUser
#
# Revision 1.1  2004/04/22 20:27:57  naydenoa
# Initial revision
#
...
##################
sub validateUser {  # routine to validate a user of the DB system
##################
     my %args = (
          userName => "",
          password => "",
...
#     my $sqlcode = "select password from $args{schema}.users where (username = '$username') and (password = '$password') and (isactive = 'T')";
#     my ($test_password) = $args{dbh}->selectrow_array($sqlcode);
...
###########################
sub getPasswordExpiration { # get a users password expiration date/time
###########################
    my %args = (
          userID => 0,
          @_,
