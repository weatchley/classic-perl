#
# $Source: /data/dev/rcs/prp/perl/RCS/PDF.pm,v $
# $Revision: 1.3 $ 
# $Date: 2004/12/16 16:18:47 $
# $Author: naydenoa $
# $Locker:  $
#
# $Log: PDF.pm,v $
# Revision 1.3  2004/12/16 16:18:47  naydenoa
# Clean up and tweaks for phase 2 development; suppressed several
# warnings to reduce log litter.
#
# Revision 1.2  2004/06/15 23:11:07  naydenoa
# Updated reporting format to print on 11 x 17
#
# Revision 1.1  2004/04/23 23:36:29  naydenoa
# Initial revision
#
...
###################
    ...
    for (my $i=0; $i<=$#headers; $i++) {
        $headers[$i]{sameLine} = ($headers[$i]{sameLine}) ? $headers[$i]{sameLine} : "";  
