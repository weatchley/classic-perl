...
# Sessions.pm
#
# $Source: /usr/local/homes/gilmored/rcs/prp/perl/RCS/Sessions.pm,v $
#
# $Revision: 1.2 $
#
# $Date: 2009/02/06 19:49:49 $
#
# $Author: gilmored $
#
# $Locker: gilmored $
#
# $Log: Sessions.pm,v $
# Revision 1.2  2009/02/06 19:49:49  gilmored
# Allow sessionValidate to continue without a session (for GUEST login)
#
# Revision 1.1  2004/04/22 20:34:08  naydenoa
# Initial revision
#
#
#
...
###################################################################################################################################
    ...
    my $status = 0;
    my $sID = $args{sessionID};
    
    eval {
        if ($sID eq 'none' || $sID==0) {
            $status = 1;
        } else {
