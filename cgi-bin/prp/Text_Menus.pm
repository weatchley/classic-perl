# Text Menus file
#
# $Source: /data/dev/rcs/prp/perl/RCS/Text_Menus.pm,v $
# $Revision: 1.1 $
# $Date: 2004/04/22 20:37:38 $
# $Author: naydenoa $
# $Locker:  $
#
# $Log: Text_Menus.pm,v $
# Revision 1.1  2004/04/22 20:37:38  naydenoa
# Initial revision
#
#
...
#####################
sub _menuInitialize { # Initialze menu system
#####################
...
#################
sub _initObject { # initialize object
#################
    my $self = shift;
    $self->{'imageSource'} = '';
