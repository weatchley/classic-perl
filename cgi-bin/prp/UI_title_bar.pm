...
# UI title bar
#
# $Source: /data/dev/rcs/prp/perl/RCS/UI_title_bar.pm,v $
# $Revision: 1.1 $
# $Date: 2004/04/22 20:45:25 $
# $Author: naydenoa $
# $Locker:  $
# $Log: UI_title_bar.pm,v $
# Revision 1.1  2004/04/22 20:45:25  naydenoa
# Initial revision
#
#
#
...
<tr><td width=24% align=left><table cellpadding=0 cellspacing=0 border=1><tr><td><b><font size=2 color=#003000>User/ID:&nbsp;&nbsp;</font>
...
<td width=24% align=right><table cellpadding=0 cellspacing=0 border=1><tr><td><b>
