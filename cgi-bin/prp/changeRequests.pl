...
# CR processing
#
# $Source: /data/dev/rcs/prp/perl/RCS/changeRequests.pl,v $
# $Revision: 1.1 $
# $Date: 2004/04/22 20:47:21 $
# $Author: naydenoa $
# $Locker:  $
# $Log: changeRequests.pl,v $
# Revision 1.1  2004/04/22 20:47:21  naydenoa
# Initial revision
#
#
...
##################################
    print "<body bgcolor=#f0f0f0 text=$SYSFontColor link=#0000ff vlink=#0000ff alink=#0000ff topmargin=0 leftmargin=0>\n";
...
###########################
    ...
    print "<BODY BGcolor=#f0f0f0 TEXT=$SYSFontColor LINK=#0000FF VLINK=#0000FF ALINK=#0000FF TOPMARGIN=0 LEFTMARGIN=0><center><br>\n";
