#!/usr/local/bin/perl
#
# $Source: /data/dev/rcs/prp/perl/RCS/text_labels.pl,v $
# $Revision: 1.1 $
# $Date: 2004/04/22 20:56:57 $
# $Author: naydenoa $
# $Locker:  $
#
# $Log: text_labels.pl,v $
# Revision 1.1  2004/04/22 20:56:57  naydenoa
# Initial revision
#
#
...
sub init_colors {
    ...
    # test for valid parameter. If param not valid cannot proceed so we die.
